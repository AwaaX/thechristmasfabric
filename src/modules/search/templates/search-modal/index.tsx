...
export default function SearchModal() {
  ...
  return (
    <div className="relative z-[75]">
      <div className="fixed inset-0 bg-opacity-75 backdrop-blur-md opacity-100 h-[100dvh] w-screen" />
      <div className="fixed inset-0 px-5 sm:p-0" ref={searchRef}>
        <div className="flex flex-col justify-start w-full h-fit transform p-5 items-center text-left align-middle transition-all max-h-[75vh] bg-transparent shadow-none">
          ...
          >
            ...
            >
              <div className="w-full flex items-center gap-x-2 p-4 bg-white text-gray-500  rounded-rounded border border-gray-200">
                <MagnifyingGlassMini />
                <SearchBox />
              </div>
